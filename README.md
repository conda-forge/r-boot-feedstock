...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-boot-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-boot-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-boot-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-boot-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-boot-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-boot-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-boot/badges/version.svg)](https://anaconda.org/conda-forge/r-boot)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-boot/badges/downloads.svg)](https://anaconda.org/conda-forge/r-boot)
